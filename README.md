...
The pipeline produces detailed output files under `output/typer/`. See full descriptions in the original [GBS-Typer documentation](https://github.com/sanger-bentley-group/GBS-Typer-sanger-nf#outputs), including:
